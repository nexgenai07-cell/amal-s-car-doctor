 ...
 * GalleryHero.jsx
 * ================================================================
 * The intro section at the top of the Gallery page:
 * "OUR WORK" label -> "Proof in Every Detail." heading ->
 ...
 * letter-spacing animates from normal, out to slightly wider, and
 * back, on an infinite loop. This is a "width" breathing effect
 * rather than a scale (grow/shrink) effect: the text never changes
 * size or height, only how loosely its letters sit next to each
 * other, so nothing else on the page shifts around it. Matches the
 * same breathing heading used on the About Us page hero.
 * ================================================================
 */
      ...
      <Container>
        ...
        >
          ...
          <p className="text-neutral text-base sm:text-lg">
            Real cars. Real fixes. Real results from Riyadh's most trusted
            workshop.
          </p>
        </motion.div>
      </Container>
